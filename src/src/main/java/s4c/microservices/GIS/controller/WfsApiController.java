...
public class WfsApiController implements WfsApi {
    ...
    public ResponseEntity<WfsCapabilities> wfsGetCapabilities( @NotNull@ApiParam(value = "Service name. Value is WFS.", required = true, defaultValue = "WFS") @RequestParam(value = "service", required = true, defaultValue="WFS") String service,
    ...
    public ResponseEntity<List<Device>> wfsGetFeature( @NotNull@ApiParam(value = "Service name. Value is WFS.", required = true, defaultValue = "WFS") @RequestParam(value = "service", required = true, defaultValue="WFS") String service,
         @NotNull@ApiParam(value = "Service version. Value is one of 1.1.0, 2.0.0", required = true, allowableValues = "1.1.0, 2.0.0", defaultValue = "2.0.0") @RequestParam(value = "version", required = true, defaultValue="2.0.0") String version,
