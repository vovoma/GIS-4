...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2018-02-02T09:41:00.256Z")
...
public interface WfsApi {
    ...
    @RequestMapping(value = "/wfs/GetFeature",
        produces = { "application/xml", "application/jon", "application/javascript", "text/csv", "application/zip" }, 
        method = RequestMethod.GET)
